   ...
   <form action="index.php" method="POST" >
     ...
     <table>
	    ...
	    <td>
         ...
         <td> 
		  <input type="text" id="nume" name="nume" placeholder="Surname"  value="<?php if(isset($nume)){echo $nume; }?>"
		   <?php if(isset($errors['nume'])){ echo "class='error'";}?>><span class="errorMessage"><?php if(isset($errors['nume'])){ echo "** ".$errors['nume'] ;} ?></span> 	    
		<td>
       </tr> 
	  ...
	  <tr>
       ...
       <td>		
		<input type="text" id="prenume" name="prenume" placeholder="LastName"  value="<?php if(isset($prenume)){echo $prenume; }?>"
		 <?php if(isset($errors['prenume'])){ echo "class='error'";}?>><span class="errorMessage"><?php if(isset($errors['prenume'])){ echo "** ".$errors['prenume'] ;} ?></span> 	    
	   </td>
	  </tr>
	  ...
	  <tr>
	   <td>
		...
		<td> 	   
		 <input type="text" id="gen" name="gen" placeholder="Gender"  value="<?php if(isset($gen)){echo $gen; }?>"
		  <?php if(isset($errors['gen'])){ echo "class='error'";}?>><span class="errorMessage"><?php if(isset($errors['gen'])){ echo "** ".$errors['gen'] ;} ?></span> 	    
		</td>
	   </tr> 
	   ...
	   <td>
		...
		<td> 
		  <input type="text" id="varsta" name="varsta" placeholder="Age"  value="<?php if(isset($varsta)){echo $varsta; }?>"
		   <?php if(isset($errors['varsta'])){ echo "class='error'";}?>><span class="errorMessage"><?php if(isset($errors['varsta'])){ echo "** ".$errors['varsta'] ;} ?></span> 	    
		</td>
	   </tr> 
	   ...
	   <tr>
		...
		<td> 
		  <input type="text" id="inaltime" name="inaltime" placeholder="Height(in cm)" value="<?php if(isset($inaltime)){echo $inaltime; }?>"
		   <?php if(isset($errors['inaltime'])){ echo "class='error'";}?>><span class="errorMessage"><?php if(isset($errors['inaltime'])){ echo "** ".$errors['inaltime'] ;} ?></span> 	    
		</td>
	   </tr> 
	  ...
	  <tr>
		...
		<td> 
		  <input type="text" id="greutate" name="greutate" placeholder="Weight(in kg)"  value="<?php if(isset($greutate)){echo $greutate; }?>"
		  <?php if(isset($errors['greutate'])){ echo "class='error'";}?>><span class="errorMessage"><?php if(isset($errors['greutate'])){ echo "** ".$errors['greutate'] ;} ?></span> 	    
		 </td>
	  </tr> 
	   ...
	   <td>
        ...
        <td> 		
		 <input type="text" id="cod_boala" name="cod_boala" placeholder="Diagnostic_id"  value="<?php if(isset($cod_boala)){echo $cod_boala; }?>"
		  <?php if(isset($errors['cod_boala'])){ echo "class='error'";}?>><span class="errorMessage"><?php if(isset($errors['cod_boala'])){ echo "** ".$errors['cod_boala'] ;} ?></span> 	    
		</td>
	   </tr>
	   ...
	   <td>
        ...
        <td>	   
		 <input type="text" id="cod_medic" name="cod_medic" placeholder="Doctor_id"  value="<?php if(isset($cod_medic)){echo $cod_medic; }?>"
		 <?php if(isset($errors['cod_medic'])){ echo "class='error'";}?>><span class="errorMessage"><?php if(isset($errors['cod_medic'])){ echo "** ".$errors['cod_medic'] ;} ?></span> 	    
		</td>
	   </tr>
