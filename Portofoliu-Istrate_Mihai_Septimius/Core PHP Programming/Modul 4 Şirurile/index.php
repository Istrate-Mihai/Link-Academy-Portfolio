...
<body>
    <p>To contact our management you can refer to one of the following email adresses:</p>
     ...
     <table>
        <tr>
<?php   for($i = 0; $i < 1; $i++) : 
           $m = count($peopleData[$i]); //Just the number of the elements of the first row needed,I used a separate loop because in the first row I want <th> elements not <td>  
              for($j = 0; $j < $m; $j++ ) :
?>
